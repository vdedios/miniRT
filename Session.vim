...
exe 'vert 2resize ' . ((&columns * 100 + 136) / 272)
exe 'vert 3resize ' . ((&columns * 94 + 136) / 272)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
18
normal! zo
let s:l = 24 - ((14 * winheight(0) + 26) / 53)
...
wincmd w
argglobal
if bufexists("src/geometry.c") | buffer src/geometry.c | else | edit src/geometry.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
